...
public:
    ...
    void setupUi(QWidget *MainScreen)
    {
        ...
        l_battery_value = new QLabel(widget_2);
        l_battery_value->setObjectName(QStringLiteral("l_battery_value"));
        l_battery_value->setGeometry(QRect(260, 5, 51, 25));
        QPalette palette5;
        ...
        l_battery_value->setPalette(palette5);
        QFont font4;
        font4.setFamily(QStringLiteral("Segoe UI"));
        font4.setPointSize(12);
        font4.setBold(true);
        font4.setWeight(75);
        l_battery_value->setFont(font4);
        l_battery_value->setStyleSheet(QLatin1String("color: rgb(255, 255, 255);\n"
"background-image: url(:/icons/general/fondo_transparente.png);\n"
"border-image: url(:/icons/general/fondo_transparente.png);"));
        l_battery_value->setScaledContents(true);
        l_battery_value->setAlignment(Qt::AlignCenter);
        ...
        QPalette palette6;
        QBrush brush3(QColor(62, 167, 132, 255));
...
""));
        ...
        l_max_value->setPalette(palette7);
        QFont font6;
        font6.setFamily(QStringLiteral("Swis721 Cn BT"));
        font6.setPointSize(24);
        font6.setBold(false);
        font6.setWeight(50);
        l_max_value->setFont(font6);
        ...
        l_min_value->setPalette(palette9);
        l_min_value->setFont(font6);
...
"background-image: url(:/icons/general/fondo_transparente.png);"));
        ...
        l_error_text->setPalette(palette15);
        QFont font10;
        font10.setFamily(QStringLiteral("Swis721 Cn BT"));
        font10.setPointSize(18);
        font10.setBold(false);
        font10.setWeight(50);
        l_error_text->setFont(font10);
...
"color: rgb(220, 0, 0);"));
    ...
    void retranslateUi(QWidget *MainScreen)
    {
        ...
        l_battery_value->setText(QApplication::translate("MainScreen", "100%", nullptr));
